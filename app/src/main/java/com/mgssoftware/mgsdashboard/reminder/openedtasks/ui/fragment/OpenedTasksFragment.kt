package com.mgssoftware.mgsdashboard.reminder.openedtasks.ui.fragment
...
import com.mgssoftware.mgsdashboard.reminder.openedtasks.adapters.OpenedTasksAdapter
...
class OpenedTasksFragment :
    BaseFragment<FragmentOpenedTasksBinding>(FragmentOpenedTasksBinding::inflate) {
    ...
    private fun rvTaskCompletionObserver(response: ReminderAPI?) {
