...
import com.mgssoftware.mgsdashboard.petner.data.model.CommentsInLastFiveMonthsChart
import com.mgssoftware.mgsdashboard.petner.data.model.ConversationsInLastFiveWeeksChart
import com.mgssoftware.mgsdashboard.petner.data.model.PostsInLastFiveMonthsChart
import com.mgssoftware.mgsdashboard.petner.data.model.UsersInLastFiveMonthsChart
    ...
    fun usersInLastFiveMonthsChart(
        ...
        if (usersInLastFiveMonthsChart != null) {
            ...
            for (i in usersInLastFiveMonthsChart.indices) {
                ...
                barBottomValue.add(convertToDateString(usersInLastFiveMonthsChart[i]?.createdAt.toString())
                )
            }
    ...
    fun postsInLastFiveMonthsChart(
        ...
        if (postsInLastFiveMonthsChart != null) {
            ...
            for (i in postsInLastFiveMonthsChart.indices) {
                ...
                barBottomValue.add( convertToDateString(postsInLastFiveMonthsChart[i]?.createdAt.toString()))
            }
    ...
    fun conversationsInLastFiveWeeksChart(
        ...
        if (conversationsInLastFiveWeeksChart != null) {
            ...
            for (i in conversationsInLastFiveWeeksChart.indices) {
                ...
                barBottomValue.add(convertToDateString(conversationsInLastFiveWeeksChart[i]?.createdAt.toString()))
            }
    ...
    fun commentsInLastFiveMonthsChart(
        ...
        if (commentsInLastFiveMonthsChart != null) {
            ...
            for (i in commentsInLastFiveMonthsChart.indices) {
                ...
                barBottomValue.add(convertToDateString(commentsInLastFiveMonthsChart[i]?.createdAt.toString()))
            }
